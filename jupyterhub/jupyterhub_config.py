...
# --- SSL ---
c.JupyterHub.ssl_cert = '/etc/letsencrypt/live/jupyterhub.example.com/fullchain.pem'
c.JupyterHub.ssl_key = '/etc/letsencrypt/live/jupyterhub.example.com/privkey.pem'
